...
class _State extends State<OpenSubtitlesSheet> {
    ...
    child: ConstrainedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Row(children: [
            const Icon(Icons.cloud_download_outlined, color: Color(0xFFA26592), size: 20),
          ...
          Row(children: [
            Expanded(child: TextField(
              ...
              decoration: InputDecoration(
                ...
                filled: true, fillColor: const Color(0xFF2C1B2E),
            ...
            FilledButton(
              ...
              style: FilledButton.styleFrom(backgroundColor: const Color(0xFFA26592), minimumSize: const Size(0, 44)),
          ...
          if (_loading) Padding(padding: EdgeInsets.all(24), child: CircularProgressIndicator(color: Color(0xFFA26592)))
      ...
      child: ListTile(
        ...
        subtitle: Row(children: [
          ...
          Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 1),
            ...
            child: Text(f.type == 'tvshow' ? L.tvShow : L.movie, style: const TextStyle(color: Color(0xFFA26592), fontSize: 10))),
        ]),
  ...
  Widget _posterFallback() => Container(width: 42, height: 58, color: const Color(0xFF1D1220),
      ...
      ..._subs.map((s) => Container(
        ...
        child: Row(children: [
          Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
            decoration: BoxDecoration(color: const Color(0xFFA26592).withOpacity(0.2), borderRadius: BorderRadius.circular(8)),
            child: Text(s.language.toUpperCase(), style: const TextStyle(color: Color(0xFFA26592), fontSize: 11, fontWeight: FontWeight.bold))),
          const SizedBox(width: 10),
          ...
          IconButton(icon: const Icon(Icons.download, color: Color(0xFFA26592)), onPressed: () => _download(s)),
        ]),
      )),
    ];
  }
  ...
  Widget _langChip(String label, String code) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: _langFilter == code ? const Color(0xFFA26592) : const Color(0xFF2C1B2E),
        borderRadius: BorderRadius.circular(20)),
