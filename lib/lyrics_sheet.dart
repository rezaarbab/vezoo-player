    ...
    child: ConstrainedBox(
      ...
      child: Column(children: [
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal:16),
          child: Row(children: [
            const Icon(Icons.music_note, color: Color(0xFFA26592), size: 20),
        ...
        Padding(padding: const EdgeInsets.fromLTRB(16,8,16,8),
          child: Row(children: [
            ...
            FilledButton(
              ...
              style: FilledButton.styleFrom(backgroundColor:const Color(0xFFA26592), padding:const EdgeInsets.symmetric(horizontal:14,vertical:10)),
              child: _loading
              ...
              itemBuilder: (_,i) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF2C1B2E),
                    borderRadius: BorderRadius.circular(10)),
                  child: ListTile(
                    dense: true,
                    leading: Container(width:36,height:36,
                      decoration:BoxDecoration(color:const Color(0xFFA26592).withOpacity(0.15),borderRadius:BorderRadius.circular(8)),
                      child: Icon(t.hasSynced ? Icons.lyrics_rounded : Icons.text_fields_rounded,
                        color:t.hasSynced ? const Color(0xFFA26592) : Colors.white38, size:18)),
                    ...
                    trailing: t.hasSynced
                      ? Container(padding:const EdgeInsets.symmetric(horizontal:6,vertical:2),
                          decoration:BoxDecoration(color:const Color(0xFFA26592).withOpacity(0.2),borderRadius:BorderRadius.circular(4)),
                          child:const Text('SYNC',style:TextStyle(color:Color(0xFFA26592),fontSize:9,fontWeight:FontWeight.bold)))
        ...
        if (_applying) const LinearProgressIndicator(color:Color(0xFFA26592), backgroundColor:Colors.white12),
      ]),
    ),
  );
}
