...
class _State extends State<OnlinePlayerSheet> {
  ...
  Future<void> _showCookieSheet(BuildContext ctx) async {
    showModalBottomSheet(context: ctx, isScrollControlled: true, backgroundColor: const Color(0xFF241627),
      ...
      builder: (_) => StatefulBuilder(builder: (ctx2, ss) => DraggableScrollableSheet(
        ...
        builder: (_, sc) => ListView(controller: sc, padding: const EdgeInsets.all(20), children: [
          Row(children: [
            const Icon(Icons.cookie_rounded, color: Color(0xFFA26592), size: 20),
  ...
  Widget _cookieMethod(String title, List<String> steps) => Container(
    padding: const EdgeInsets.all(12),
    decoration: BoxDecoration(color: const Color(0xFF241627), borderRadius: BorderRadius.circular(10)),
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      ...steps.asMap().entries.map((e) => Padding(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('${e.key+1}. ', style: const TextStyle(color: Color(0xFFA26592), fontSize: 11, fontWeight: FontWeight.bold)),
  ...
  void _showSupportedSites(BuildContext ctx) {
    showDialog(context: ctx, builder: (_) => AlertDialog(
      ...
      title: Row(children: [
        const Icon(Icons.public_rounded, color: Color(0xFFA26592), size: 18),
        const SizedBox(width: 8),
        const Text('سایت‌های پشتیبانی شده', style: TextStyle(color: Colors.white, fontSize: 14)),
        const Spacer(),
        Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
          decoration: BoxDecoration(color: const Color(0xFFA26592), borderRadius: BorderRadius.circular(12)),
      ...
      actions: [TextButton(
        ...
        child: const Text('بستن', style: TextStyle(color: Color(0xFFA26592))))],
    ));
  }
  ...
  @override Widget build(BuildContext context) {
    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, sc) => Container(
        decoration: const BoxDecoration(color: Color(0xFF1D1220),
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16), child: Row(children: [
            ...
            Expanded(child: TextField(controller: _ctrl,
              ...
              decoration: InputDecoration(
                ...
                filled: true, fillColor: const Color(0xFF241627),
                ...
                ...List.generate(_qualities.length, (i) {
                  ...
                  return Container(margin: const EdgeInsets.only(bottom: 6),
                    ...
                    child: ListTile(dense: true,
                      leading: const Icon(Icons.play_circle_outline_rounded, color: Color(0xFFA26592), size: 20),
                      title: Text(q.label, style: const TextStyle(color: Colors.white, fontSize: 13)),
                      trailing: Row(mainAxisSize: MainAxisSize.min, children: [
                        IconButton(icon: const Icon(Icons.play_arrow_rounded, color: Color(0xFFA26592), size: 22),
