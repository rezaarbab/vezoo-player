...
class _AiModelsScreenState extends State<AiModelsScreen> {
  ...
  Widget build(BuildContext ctx) => Scaffold(
    ...
    appBar: AppBar(
      ...
      actions:[
        IconButton(
          icon:const Icon(Icons.history,color:Color(0xFFA26592)),
          tooltip:L.subtitleHistory,
          onPressed:()=>Navigator.push(ctx,MaterialPageRoute(builder:(_)=>const AiHistoryScreen())),
        ),
        IconButton(
          icon:const Icon(Icons.playlist_add_check,color:Color(0xFFA26592)),
    ...
    body: _loading
      ? const Center(child:CircularProgressIndicator(color:Color(0xFFA26592)))
      : Column(children:[
          _infoCard(),
          _cacheCard(),
          _filterBar(),
  ...
  Widget _infoCard() => Padding(
    ...
    child:Container(
      ...
      decoration:BoxDecoration(color:const Color(0xFF1D1220).withOpacity(0.8),borderRadius:BorderRadius.circular(12)),
      child:Row(children:[
        const Icon(Icons.info_outline,color:Color(0xFFA26592),size:18),
  ...
  Widget _chip(String label,String v) => GestureDetector(
    ...
    child:Container(
      ...
      decoration:BoxDecoration(
        color:_filter==v?const Color(0xFFA26592):const Color(0xFF1D1220),
  ...
  Widget _buildCard(WhisperModelDef m){
    ...
    return Container(
      ...
      decoration:BoxDecoration(
        color:const Color(0xFF1D1220),
        borderRadius:BorderRadius.circular(16),
        border:Border.all(color: act?const Color(0xFFA26592):(recommended?Colors.amber:Colors.white12), width:act||recommended?2:1),
      ),
      child:Padding(padding:const EdgeInsets.all(16),child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[

        Row(children:[
          _tag(m.name, const Color(0xFFA26592)),
  ...
  Widget _stars(String label, int n) => Row(mainAxisSize:MainAxisSize.min,children:[
    ...
    ...List.generate(5,(i)=>Icon(i<n?Icons.star:Icons.star_border,size:12,
      color:i<n?const Color(0xFFA26592):Colors.white24)),
  ]);
}
