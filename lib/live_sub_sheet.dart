...
class _State extends State<LiveSubSheet> {
  ...
  Widget build(BuildContext ctx) => SafeArea(
    child: ConstrainedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: _loading
          ? SizedBox(height: 100, child: Center(child: CircularProgressIndicator(color: Color(0xFFA26592))))
          : Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFFA26592).withOpacity(0.1), borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: const Color(0xFFA26592).withOpacity(0.3))),
                child: Text(
                  L.liveSubDesc,
              ...
              if (_models.isEmpty) ...[
                ...
                _row(L.language, DropdownButton<String>(
                  value: _lang, isExpanded: true, dropdownColor: const Color(0xFF2C1B2E),
                  style: const TextStyle(color: Colors.white, fontSize: 13),
                ...
                if(_syncTranslate)...[
                  ...
                  Container(
                    ...
                    decoration:BoxDecoration(color:const Color(0xFF2C1B2E),borderRadius:BorderRadius.circular(8)),
                    child:Row(children:[
                      Text(L.targetLanguage,style:TextStyle(color:Colors.white60,fontSize:12)),
                      const SizedBox(width:8),
                      Expanded(child:DropdownButton<String>(
                        value:_syncLang,isExpanded:true,dropdownColor:const Color(0xFF2C1B2E),
                      ...
                      Row(children: [
                        ...
                        ...[0.25, 0.5, 0.75].map((s) => Padding(
                          ...
                          child: GestureDetector(onTap: () => setState(() => _behindSpeed = s), child: Container(
                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                            decoration: BoxDecoration(color: _behindSpeed == s ? const Color(0xFFA26592) : const Color(0xFF1D1220), borderRadius: BorderRadius.circular(8)),
  ...
  Widget _switchRow(String label, bool val, void Function(bool) onChanged) => Container(
    ...
    child: Row(children: [
      ...
      const Spacer(),
      Switch(value: val, activeColor: const Color(0xFFA26592), onChanged: onChanged),
    ]),
  );
  ...
  Widget _chunkChip(String label, int ms) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: _chunkMs == ms ? const Color(0xFFA26592) : const Color(0xFF1D1220),
  ...
  Widget _behindChip(String label, LiveBehindAction action, IconData icon) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: _behindAction == action ? Colors.red.withOpacity(0.2) : const Color(0xFF1D1220),
        borderRadius: BorderRadius.circular(8),
